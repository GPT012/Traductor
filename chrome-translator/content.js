// ===================================
// AUTO TRANSLATOR v27.7 - CONVERSATION MODE
...
(function () {
  ...
  console.log('%c🌐 Translator v27.7', 'background: #000; color: white; padding: 6px 12px; border-radius: 999px;');
  ...
  function init() {
    ...
    loadConfig();
    console.log('🌐 v27.7 | Conversation Mode Ready');
  }
